...
var routeSecurityMatrix = []routeSecurityCase{
	...
	{name: "user create", method: http.MethodPost, path: "/user/create", body: `{"username":"alice","nickname":"Alice","password":"Valid-pass123","status":1,"roleIds":[],"departmentId":1}`, level: routeAuthorized, rpcMethod: "CreateUser"},
	{name: "user update", method: http.MethodPost, path: "/user/update", body: `{"id":9,"nickname":"Alice","departmentId":1}`, level: routeAuthorized, rpcMethod: "UpdateUser"},
	...
	{name: "user password", method: http.MethodPost, path: "/user/password/reset", body: `{"id":9,"password":"Valid-pass123"}`, level: routeAuthorized, rpcMethod: "ResetUserPassword"},
	...
	{name: "user department options", method: http.MethodPost, path: "/user/department/options", level: routeAuthorized, rpcMethod: "ListDepartments"},
	{name: "department list", method: http.MethodPost, path: "/department/list", level: routeAuthorized, rpcMethod: "ListDepartments"},
	{name: "department get", method: http.MethodPost, path: "/department/get", body: `{"id":9}`, level: routeAuthorized, rpcMethod: "GetDepartment"},
	{name: "department create", method: http.MethodPost, path: "/department/create", body: `{"parentId":0,"name":"研发部","sort":0,"remark":"","status":1}`, level: routeAuthorized, rpcMethod: "CreateDepartment"},
	{name: "department update", method: http.MethodPost, path: "/department/update", body: `{"id":9,"parentId":0,"name":"研发部","sort":0,"remark":""}`, level: routeAuthorized, rpcMethod: "UpdateDepartment"},
	{name: "department status", method: http.MethodPost, path: "/department/status/update", body: `{"id":9,"status":0}`, level: routeAuthorized, rpcMethod: "UpdateDepartmentStatus"},
	{name: "department delete", method: http.MethodPost, path: "/department/delete", body: `{"id":9}`, level: routeAuthorized, rpcMethod: "DeleteDepartment"},
